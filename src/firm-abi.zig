const std = @import("std");
    ...
    pub const calling_convention = union(convention) {
        calling_convention : calling_convention_enum,
        calling_convention_special : calling_convention_enum.calling_helpers,
        value : u32
    };
    ...
    pub const ir_dump_verbosity_t = enum(u32) { dump_verbosity_onlynames = 0x00000001, dump_verbosity_fields = 0x00000002, dump_verbosity_methods = 0x00000004, dump_verbosity_nostatic = 0x00000040, dump_verbosity_typeattrs = 0x00000008, dump_verbosity_entattrs = 0x00000010, dump_verbosity_entconsts = 0x00000020, dump_verbosity_accessStats = 0x00000100, dump_verbosity_max = 0x4FF00FBE, };
 ...
 pub const loop_element = extern union {
    ...
    pub extern const tarval_unknown: ?*ir_tarval;pub const check_alloc_entity_func = ?fn (?*ir_entity) callconv(.C) i32;
...
pub fn isParameterEntity(entity : ?*const ir_entity) i32 {
    return  low_level.is_parameter_entity(entity) ;
}
...
pub fn isCompoundEntity(ent : ?*const ir_entity) i32 {
    return  low_level.is_compound_entity(ent) ;
}
pub fn isMethodEntity(ent : ?*const ir_entity) i32 {
    return  low_level.is_method_entity(ent) ;
}
pub fn isAliasEntity(ent : ?*const ir_entity) i32 {
    return  low_level.is_alias_entity(ent) ;
}
...
pub fn isSubclassOf(low : ?*const ir_type, high : ?*const ir_type) i32 {
    return  low_level.is_SubClass_of(low, high) ;
}
pub fn isSubclassPtrOf(low : ?*ir_type, high : ?*ir_type) i32 {
    return  low_level.is_SubClass_ptr_of(low, high) ;
}
pub fn isOverwrittenBy(high : ?*ir_entity, low : ?*ir_entity) i32 {
    return  low_level.is_overwritten_by(high, low) ;
}
...
pub fn isClassTransSubtype(tp : ?*const ir_type, subtp : ?*const ir_type) i32 {
    return  low_level.is_class_trans_subtype(tp, subtp) ;
}
...
pub fn isClassType(clss : ?*const ir_type) i32 {
    return  low_level.is_Class_type(clss) ;
}
...
pub fn isStructType(strct : ?*const ir_type) i32 {
    return  low_level.is_Struct_type(strct) ;
}
...
pub fn isUnionType(uni : ?*const ir_type) i32 {
    return  low_level.is_Union_type(uni) ;
}
pub fn newTypeMethod(n_param : usize, n_res : usize, is_variadic : i32, cc_mask : calling_convention, property_mask : mtp_additional_properties) ?*ir_type {
    switch(cc_mask) {
        .calling_convention => return low_level.new_type_method(n_param, n_res, is_variadic, @enumToInt(cc_mask.calling_convention), property_mask),
        .calling_convention_special => return low_level.new_type_method(n_param, n_res, is_variadic, @enumToInt(cc_mask.calling_convention_special), property_mask),
        .value => return low_level.new_type_method(n_param, n_res, is_variadic, cc_mask.value, property_mask),
    }
}
...
pub fn isMethodVariadic(method : ?*const ir_type) i32 {
    return  low_level.is_method_variadic(method) ;
}
...
pub fn isMethodType(method : ?*const ir_type) i32 {
    return  low_level.is_Method_type(method) ;
}
...
pub fn isArrayType(array : ?*const ir_type) i32 {
    return  low_level.is_Array_type(array) ;
}
...
pub fn isPointerType(pointer : ?*const ir_type) i32 {
    return  low_level.is_Pointer_type(pointer) ;
}
pub fn newTypePrimitive(mode : ?*ir_mode) ?*ir_type {
    return  low_level.new_type_primitive(mode) ;
}
pub fn isPrimitiveType(primitive : ?*const ir_type) i32 {
    return  low_level.is_Primitive_type(primitive) ;
}
pub fn getCodeType() ?*ir_type {
    return  low_level.get_code_type() ;
}
pub fn isCodeType(tp : ?*const ir_type) i32 {
    return  low_level.is_code_type(tp) ;
}
pub fn getUnknownType() ?*ir_type {
    return  low_level.get_unknown_type() ;
}
pub fn isUnknownType(@"type" : ?*const ir_type) i32 {
    return  low_level.is_unknown_type(@"type") ;
}
...
pub fn isCompoundType(tp : ?*const ir_type) i32 {
    return  low_level.is_compound_type(tp) ;
}
pub fn newTypeFrame() ?*ir_type {
    return  low_level.new_type_frame() ;
}
pub fn isFrameType(tp : ?*const ir_type) i32 {
    return  low_level.is_frame_type(tp) ;
}
pub fn cloneFrameType(@"type" : ?*ir_type) ?*ir_type {
    return  low_level.clone_frame_type(@"type") ;
}
pub fn isSegmentType(tp : ?*const ir_type) i32 {
    return  low_level.is_segment_type(tp) ;
}
...
pub fn isReinterpretCast(src : ?*const ir_mode, dst : ?*const ir_mode) i32 {
    return  low_level.is_reinterpret_cast(src, dst) ;
}
...
pub fn isIrgCallerBackedge(irg : ?*const ir_graph, pos : usize) i32 {
    return  low_level.is_irg_caller_backedge(irg, pos) ;
}
...
pub fn isIrgCalleeBackedge(irg : ?*const ir_graph, pos : usize) i32 {
    return  low_level.is_irg_callee_backedge(irg, pos) ;
}
...
pub fn isCdepOn(dependee : ?*const ir_node, candidate : ?*const ir_node) i32 {
    return  low_level.is_cdep_on(dependee, candidate) ;
}
...
pub fn isAsm(node : ?*const ir_node) i32 {
    return  low_level.is_ASM(node) ;
}
...
pub fn isAdd(node : ?*const ir_node) i32 {
    return  low_level.is_Add(node) ;
}
...
pub fn isAddress(node : ?*const ir_node) i32 {
    return  low_level.is_Address(node) ;
}
...
pub fn isAlign(node : ?*const ir_node) i32 {
    return  low_level.is_Align(node) ;
}
...
pub fn isAlloc(node : ?*const ir_node) i32 {
    return  low_level.is_Alloc(node) ;
}
...
pub fn isAnchor(node : ?*const ir_node) i32 {
    return  low_level.is_Anchor(node) ;
}
...
pub fn isAnd(node : ?*const ir_node) i32 {
    return  low_level.is_And(node) ;
}
...
pub fn isBad(node : ?*const ir_node) i32 {
    return  low_level.is_Bad(node) ;
}
...
pub fn isBitcast(node : ?*const ir_node) i32 {
    return  low_level.is_Bitcast(node) ;
}
...
pub fn isBlock(node : ?*const ir_node) i32 {
    return  low_level.is_Block(node) ;
}
...
pub fn isBuiltin(node : ?*const ir_node) i32 {
    return  low_level.is_Builtin(node) ;
}
...
pub fn isCall(node : ?*const ir_node) i32 {
    return  low_level.is_Call(node) ;
}
...
pub fn isCmp(node : ?*const ir_node) i32 {
    return  low_level.is_Cmp(node) ;
}
...
pub fn isCond(node : ?*const ir_node) i32 {
    return  low_level.is_Cond(node) ;
}
...
pub fn isConfirm(node : ?*const ir_node) i32 {
    return  low_level.is_Confirm(node) ;
}
...
pub fn isConst(node : ?*const ir_node) i32 {
    return  low_level.is_Const(node) ;
}
...
pub fn isConv(node : ?*const ir_node) i32 {
    return  low_level.is_Conv(node) ;
}
...
pub fn isCopyb(node : ?*const ir_node) i32 {
    return  low_level.is_CopyB(node) ;
}
...
pub fn isDeleted(node : ?*const ir_node) i32 {
    return  low_level.is_Deleted(node) ;
}
...
pub fn isDiv(node : ?*const ir_node) i32 {
    return  low_level.is_Div(node) ;
}
...
pub fn isDummy(node : ?*const ir_node) i32 {
    return  low_level.is_Dummy(node) ;
}
...
pub fn isEnd(node : ?*const ir_node) i32 {
    return  low_level.is_End(node) ;
}
...
pub fn isEor(node : ?*const ir_node) i32 {
    return  low_level.is_Eor(node) ;
}
...
pub fn isFree(node : ?*const ir_node) i32 {
    return  low_level.is_Free(node) ;
}
...
pub fn isIjmp(node : ?*const ir_node) i32 {
    return  low_level.is_IJmp(node) ;
}
...
pub fn isId(node : ?*const ir_node) i32 {
    return  low_level.is_Id(node) ;
}
...
pub fn isJmp(node : ?*const ir_node) i32 {
    return  low_level.is_Jmp(node) ;
}
...
pub fn isLoad(node : ?*const ir_node) i32 {
    return  low_level.is_Load(node) ;
}
...
pub fn isMember(node : ?*const ir_node) i32 {
    return  low_level.is_Member(node) ;
}
...
pub fn isMinus(node : ?*const ir_node) i32 {
    return  low_level.is_Minus(node) ;
}
...
pub fn isMod(node : ?*const ir_node) i32 {
    return  low_level.is_Mod(node) ;
}
...
pub fn isMul(node : ?*const ir_node) i32 {
    return  low_level.is_Mul(node) ;
}
...
pub fn isMulh(node : ?*const ir_node) i32 {
    return  low_level.is_Mulh(node) ;
}
...
pub fn isMux(node : ?*const ir_node) i32 {
    return  low_level.is_Mux(node) ;
}
...
pub fn isNomem(node : ?*const ir_node) i32 {
    return  low_level.is_NoMem(node) ;
}
...
pub fn isNot(node : ?*const ir_node) i32 {
    return  low_level.is_Not(node) ;
}
...
pub fn isOffset(node : ?*const ir_node) i32 {
    return  low_level.is_Offset(node) ;
}
...
pub fn isOr(node : ?*const ir_node) i32 {
    return  low_level.is_Or(node) ;
}
...
pub fn isPhi(node : ?*const ir_node) i32 {
    return  low_level.is_Phi(node) ;
}
...
pub fn isPin(node : ?*const ir_node) i32 {
    return  low_level.is_Pin(node) ;
}
...
pub fn isProj(node : ?*const ir_node) i32 {
    return  low_level.is_Proj(node) ;
}
...
pub fn isRaise(node : ?*const ir_node) i32 {
    return  low_level.is_Raise(node) ;
}
...
pub fn isReturn(node : ?*const ir_node) i32 {
    return  low_level.is_Return(node) ;
}
...
pub fn isSel(node : ?*const ir_node) i32 {
    return  low_level.is_Sel(node) ;
}
...
pub fn isShl(node : ?*const ir_node) i32 {
    return  low_level.is_Shl(node) ;
}
...
pub fn isShr(node : ?*const ir_node) i32 {
    return  low_level.is_Shr(node) ;
}
...
pub fn isShrs(node : ?*const ir_node) i32 {
    return  low_level.is_Shrs(node) ;
}
...
pub fn isSize(node : ?*const ir_node) i32 {
    return  low_level.is_Size(node) ;
}
...
pub fn isStart(node : ?*const ir_node) i32 {
    return  low_level.is_Start(node) ;
}
...
pub fn isStore(node : ?*const ir_node) i32 {
    return  low_level.is_Store(node) ;
}
...
pub fn isSub(node : ?*const ir_node) i32 {
    return  low_level.is_Sub(node) ;
}
...
pub fn isSwitch(node : ?*const ir_node) i32 {
    return  low_level.is_Switch(node) ;
}
...
pub fn isSync(node : ?*const ir_node) i32 {
    return  low_level.is_Sync(node) ;
}
...
pub fn isTuple(node : ?*const ir_node) i32 {
    return  low_level.is_Tuple(node) ;
}
...
pub fn isUnknown(node : ?*const ir_node) i32 {
    return  low_level.is_Unknown(node) ;
}
pub fn getOpUnknown() ?*ir_op {
    return  low_level.get_op_Unknown() ;
}
pub fn isBinop(node : ?*const ir_node) i32 {
    return  low_level.is_binop(node) ;
}
pub fn isEntconst(node : ?*const ir_node) i32 {
    return  low_level.is_entconst(node) ;
}
...
pub fn isTypeconst(node : ?*const ir_node) i32 {
    return  low_level.is_typeconst(node) ;
}
...
pub fn isConstNull(node : ?*const ir_node) i32 {
    return  low_level.is_Const_null(node) ;
}
pub fn isConstOne(node : ?*const ir_node) i32 {
    return  low_level.is_Const_one(node) ;
}
pub fn isConstAllOne(node : ?*const ir_node) i32 {
    return  low_level.is_Const_all_one(node) ;
}
...
pub fn isXExceptProj(node : ?*const ir_node) i32 {
    return  low_level.is_x_except_Proj(node) ;
}
pub fn isXRegularProj(node : ?*const ir_node) i32 {
    return  low_level.is_x_regular_Proj(node) ;
}
...
pub fn isMemop(node : ?*const ir_node) i32 {
    return  low_level.is_memop(node) ;
}
...
pub fn isCfop(node : ?*const ir_node) i32 {
    return  low_level.is_cfop(node) ;
}
pub fn isUnknownJump(node : ?*const ir_node) i32 {
    return  low_level.is_unknown_jump(node) ;
}
pub fn isFragileOp(node : ?*const ir_node) i32 {
    return  low_level.is_fragile_op(node) ;
}
pub fn isIrnForking(node : ?*const ir_node) i32 {
    return  low_level.is_irn_forking(node) ;
}
pub fn isIrnConstMemory(node : ?*const ir_node) i32 {
    return  low_level.is_irn_const_memory(node) ;
}
...
pub fn isIrnConstlike(node : ?*const ir_node) i32 {
    return  low_level.is_irn_constlike(node) ;
}
pub fn isIrnKeep(node : ?*const ir_node) i32 {
    return  low_level.is_irn_keep(node) ;
}
...
pub fn isBackedge(n : ?*const ir_node, pos : i32) i32 {
    return  low_level.is_backedge(n, pos) ;
}
